  ...
  return (
    <div className=" flex justify-center  flex-row h-[calc(100%-56px)] mt-16">
      <div className="w-full max-w-[1580px]  flex flex-col lg:flex-row">
        <div className="flex flex-col  lg:w-[calc(100%-400px)] xl:w-[100%-400px] px-4 py-3 lg:py-6">
          <div className="h-[200px]   md:h-[542px] ml-[-16px] mr-[-16px] lg:ml-0 lg:mr-0">
            <ReactPlayer
          ...
          <div className="flex justify-between  flex-col md:flex-row mt-4">
            <div className="flex ">
              ...
              <div className="flex space-x-5">
                ...
                <span className="mt-1 text-center bg-black px-3 pt-2 rounded-full text-white cursor-pointer hover:bg-red-700 duration-200 ">
                  Subscribe
                </span>
              </div>
            </div>
